...
- 插件管理继续增强：插件删除 API、插件安装 latest release 解析、插件能力头 CORS 暴露和配置读取修复。
- 新增 `disable-image-generation: passthrough` 模式。
- 新增 Kimi K2.7 Code 模型。
- Composer 2.5 Fast 上下文长度提高到 200,000。
- README 项目列表新增 Quotio Desktop。
